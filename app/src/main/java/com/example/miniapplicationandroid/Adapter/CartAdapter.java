...
import com.example.miniapplicationandroid.Helper.ChangeNumberItemsListener;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.Viewholder holder, int position) {
        ...
        holder.feeEachItem.setText("DT"+listItemSelected.get(position).getPrice());
        holder.totalEachItem.setText("DT"+Math.round((listItemSelected.get(position).getNumberInCart()*listItemSelected.get(position).getPrice())));
